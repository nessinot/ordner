...
- **Tweestaps upload met titel- en tagsuggestie** (idee Bas, 2026-09-04; kandidaat pakket 15, nog geen pakketbestand). Scherm 1: alleen bestanden kiezen. Scherm 2: alle velden van het document, voorgevuld met de datum uit de tekst (wijzigen = `datumbron: gebruiker`), een voorgestelde titel en voorgestelde tags; de gebruiker kan alles aanpassen. Na opslaan een duidelijke melding "Opgeslagen".
