...
- [ ] 15 tweestaps upload — besloten 2026-09-04, opgedeeld in 15c tags als labels → 15a titel- en tagsuggestie → 15b tweestaps upload; keuzes in `IDEAS.md`. Volgende stap: pakketbestanden `werk/15c-…`, `15a-…`, `15b-…` schrijven, daarna bouwen in die volgorde
