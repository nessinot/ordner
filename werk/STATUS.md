...
- [ ] 15 tweestaps upload — besloten 2026-09-04, opgedeeld in 15c tags als labels → 15a titel- en tagsuggestie → 15b tweestaps upload; keuzes in `IDEAS.md`. Pakketbestanden `werk/15c-tags-als-labels.md`, `15a-titel-en-tagsuggestie.md`, `15b-tweestaps-upload.md` geschreven en goedgekeurd (2026-09-04); bouwen in die volgorde (releases 0.7.0 / 0.8.0 / 0.9.0)
